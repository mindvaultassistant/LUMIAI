...
abstract class AppLocalizations {
  ...
  /// No description provided for @outputReady.
  ///
  /// In en, this message translates to:
  /// **'Output ready'**
  String get outputReady;
  ...
  /// No description provided for @guestNotSignedIn.
  ///
  /// In en, this message translates to:
  /// **'Guest / Not signed in'**
  String get guestNotSignedIn;
